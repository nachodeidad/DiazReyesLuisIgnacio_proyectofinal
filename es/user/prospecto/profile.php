    ...
    <div class="card"> 
        <div class="card__img"></div> 
            <div class="card__avatar">
                <img src="<?php echo $prospecto['foto'] ? '../../../../Outsourcing/img/' . htmlspecialchars($prospecto['foto']) : 'img/user.jpg'; ?>" 
            ...
            <div class="card__title"> <h2>
                <?php echo htmlspecialchars($prospecto['nombre'] . ' ' . $prospecto['primerApellido'] . ' ' . $prospecto['segundoApellido']); ?> </h2> 
            </div> 
                <div class="card__subtitle"><?php echo nl2br(htmlspecialchars($prospecto['resumen'])); ?></div> <div class="card__subtitle">
            <?php
